...
<body style=" background:#F1F0FB;">
   ...
   ">
      ...
      left:2%;
      top:25%;"
                action="{{ route('Sing_up.store') }}" method="post"></i>
        </a>
      ...
      left:8%;
      top:40%;"
            onclick="Settings_button()"></i>

        <i id="bell_icon" class="fa-solid fa-bell"
            style="font-size:25px;
      position: absolute;
      left:13%;
      top:40%;" badge-number="0"
            onclick="showNotificationPanel(this);"></i>
  ...
  "
        ...
        <button id="openModalBtn1" class="btn-primary"
