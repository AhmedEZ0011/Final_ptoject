...
<style>
    ...
    .navbar {
        ...
        left: 0;
        z-index: 1000;
        /* ضمان ظهور الشريط فوق جميع المحتويات الأخرى */
    ...
    .custom-link {
        color: #483fc7;
        /* تغيير لون النص إلى الأحمر، يمكن تغيير اللون حسب الحاجة */
    ...
    .custom-link:hover {
        color: #7a7675;
        /* لون النص عند التمرير عليه */
        text-decoration: underline;
        /* يمكن إضافة خط تحت الرابط عند التمرير إذا رغبت في ذلك */
    }
